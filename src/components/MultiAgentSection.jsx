    ...
    return (
        <section className="w-full bg-white py-12 md:py-16 lg:py-20">
            <div className="max-w-[1360px] mx-auto px-4 md:px-6 lg:px-[40px]">
                ...
                >
                    <div className="flex flex-col max-w-[700px] mb-10 md:mb-12">
                        <div className="mb-6 md:mb-8">
                            <h2 className="text-2xl md:text-3xl lg:text-4xl font-clash font-bold mb-4 text-[#1E1E1E] leading-tight px-0 md:px-0">
                        ...
                        <p className="text-lg md:text-xl font-clash font-bold text-[#1E1E1E] mb-8">
