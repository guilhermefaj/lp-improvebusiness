    ...
    return (
        <section className="w-full bg-white py-20">
            <div className="max-w-[1360px] mx-auto px-4 md:px-6 lg:px-[40px]">
                ...
                >
                    <div className="flex flex-col max-w-[700px] mb-20">
                        <div className="mb-10">
                            <h2 className="text-3xl md:text-4xl lg:text-5xl font-clash font-bold mb-4 text-[#1E1E1E] leading-tight">
                                Sistemas Multiagentes: <span className="whitespace-nowrap">Potencializando Soluções Estratégicas</span>
                            </h2>
                        ...
                        <p className="text-xl font-clash font-bold text-[#1E1E1E]">
                    ...
                    <div className="flex justify-between items-start mt-12">
                        <motion.p
                            ...
                            className="text-gray-600 text-lg w-[566px]"
                        >
                        ...
                        <motion.button
                            ...
                            className="px-8 py-3 border-2 border-[#FF610B] text-[#FF610B] rounded-full font-semibold transition-all duration-300 hover:shadow-lg"
                        >
                            Entrar em contato
                        </motion.button>
                    </div>
